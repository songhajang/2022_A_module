...
$(document).ready(function () {
    ...
    function renderCard() {
        ...
        cardList.map((item, idx) => {
            ...
            view += `<div class="col-3 spec-card spec-card-${id}">
          <div class="card mb-4 shadow-sm">
            <div class="card-image card-hidden">
              <img class="card-img" src="/assets/products/${img}" />
              <div class="card-body">
            ...
            <div class="card-back">
              <svg class="bd-placeholder-img card-img-top w-100 h-100" width="100%" height="200" xmlns="http://www.w3.org/2000/svg"
                preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: Thumbnail">
                <rect width="100%" height="100%" fill="#55595c" style="fill-opacity: .5;" /><text x="50%" y="50%" fill="#eceeef" dy=".3em">↻</text>
              </svg>
            </div>
          </div>
        </div>
    ...
    function endGame() {
        ...
        wp.find('.card').css('border', '1px solid #f00')
    ...
    function checkCorrect() {
        ...
        if (correct) {
            ...
            target.find('.card').css('border', '1px solid green');
    ...
    finishForm.submit(function (e) {
        ...
        const mark = checklist.find('.checked-mark').first();
